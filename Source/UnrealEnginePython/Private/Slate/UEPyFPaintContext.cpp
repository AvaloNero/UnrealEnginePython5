...
#if UEP_LEGACY_ENGINE_MINOR_VERSION >= 17
	FSlateDrawElement::MakeBox(context.OutDrawElements, context.MaxLayer, context.AllottedGeometry.ToPaintGeometry(FVector2f(w, h), FSlateLayoutTransform(FVector2f(x, y))),
